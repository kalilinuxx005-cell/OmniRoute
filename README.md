...
| 🧠 Unique chat model IDs  |  1185   |         **1315**          |      —      |
...
> **351 registered providers** across the canonical chat, media, search, local, cloud-agent and system collections, including **153 carrying `hasFree: true` discovery metadata**. The chat model registry covers **269 providers / 2,587 distinct provider-model pairs / 1,315 raw model IDs**; the separate free-budget catalog has **451 per-model rows**, **39 recurring pools** and **55 recurring/keyless free-forever providers**. These are different denominators by design; definitions and pool-deduped calculations live in the [Provider Reference](docs/reference/PROVIDER_REFERENCE.md) and [Free Tiers](docs/reference/FREE_TIERS.md).
