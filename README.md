...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="#-351-ai-providers--153-catalog-marked-free">🌐 Providers</a></td>
...
## 🌐 351 AI Providers — 153 Catalog-Marked Free

</div>

> **351 registered providers** across the canonical chat, media, search, local, cloud-agent and system collections, including **153 carrying `hasFree: true` discovery metadata**. The chat model registry covers **269 providers / 2,588 distinct provider-model pairs / 1,320 raw model IDs**; the separate free-budget catalog has **452 per-model rows**, **39 recurring pools** and **55 recurring/keyless free-forever providers**. These are different denominators by design; definitions and pool-deduped calculations live in the [Provider Reference](docs/reference/PROVIDER_REFERENCE.md) and [Free Tiers](docs/reference/FREE_TIERS.md).
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/reference/FREE_TIERS.md">Free Tiers</a></b></td><td>Consolidated directory: 39 documented recurring pools / 452 cataloged free-tier entries</td></tr>
